 ...
 */
import { ComGithubGiantswarmApiextensionsPkgApisApplicationV1alpha1ChartStatusRelease } from './';
/**
 *
 * @export
...
export declare function ComGithubGiantswarmApiextensionsPkgApisApplicationV1alpha1ChartStatusFromJSON(json: any): ComGithubGiantswarmApiextensionsPkgApisApplicationV1alpha1ChartStatus;
export declare function ComGithubGiantswarmApiextensionsPkgApisApplicationV1alpha1ChartStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): ComGithubGiantswarmApiextensionsPkgApisApplicationV1alpha1ChartStatus;
export declare function ComGithubGiantswarmApiextensionsPkgApisApplicationV1alpha1ChartStatusToJSON(value?: ComGithubGiantswarmApiextensionsPkgApisApplicationV1alpha1ChartStatus | null): any;
//# sourceMappingURL=ComGithubGiantswarmApiextensionsPkgApisApplicationV1alpha1ChartStatus.d.ts.map