 ...
 */
import { ComGithubGiantswarmApiextensionsPkgApisCoreV1alpha1ChartConfigSpecConfigMap, ComGithubGiantswarmApiextensionsPkgApisCoreV1alpha1ChartConfigSpecSecret } from './';
/**
 *
 * @export
...
export declare function ComGithubGiantswarmApiextensionsPkgApisCoreV1alpha1ChartConfigSpecChartFromJSON(json: any): ComGithubGiantswarmApiextensionsPkgApisCoreV1alpha1ChartConfigSpecChart;
export declare function ComGithubGiantswarmApiextensionsPkgApisCoreV1alpha1ChartConfigSpecChartFromJSONTyped(json: any, ignoreDiscriminator: boolean): ComGithubGiantswarmApiextensionsPkgApisCoreV1alpha1ChartConfigSpecChart;
export declare function ComGithubGiantswarmApiextensionsPkgApisCoreV1alpha1ChartConfigSpecChartToJSON(value?: ComGithubGiantswarmApiextensionsPkgApisCoreV1alpha1ChartConfigSpecChart | null): any;
//# sourceMappingURL=ComGithubGiantswarmApiextensionsPkgApisCoreV1alpha1ChartConfigSpecChart.d.ts.map