 ...
 */
import { ComGithubGiantswarmApiextensionsPkgApisProviderV1alpha1AWSConfigSpecAWSAPI, ComGithubGiantswarmApiextensionsPkgApisProviderV1alpha1AWSConfigSpecAWSEtcd, ComGithubGiantswarmApiextensionsPkgApisProviderV1alpha1AWSConfigSpecAWSHostedZones, ComGithubGiantswarmApiextensionsPkgApisProviderV1alpha1AWSConfigSpecAWSIngress, ComGithubGiantswarmApiextensionsPkgApisProviderV1alpha1AWSConfigSpecAWSNode, ComGithubGiantswarmApiextensionsPkgApisProviderV1alpha1AWSConfigSpecAWSVPC, ComGithubGiantswarmApiextensionsPkgApisProviderV1alpha1CredentialSecret } from './';
/**
 *
 * @export
...
export declare function ComGithubGiantswarmApiextensionsPkgApisProviderV1alpha1AWSConfigSpecAWSFromJSON(json: any): ComGithubGiantswarmApiextensionsPkgApisProviderV1alpha1AWSConfigSpecAWS;
export declare function ComGithubGiantswarmApiextensionsPkgApisProviderV1alpha1AWSConfigSpecAWSFromJSONTyped(json: any, ignoreDiscriminator: boolean): ComGithubGiantswarmApiextensionsPkgApisProviderV1alpha1AWSConfigSpecAWS;
export declare function ComGithubGiantswarmApiextensionsPkgApisProviderV1alpha1AWSConfigSpecAWSToJSON(value?: ComGithubGiantswarmApiextensionsPkgApisProviderV1alpha1AWSConfigSpecAWS | null): any;
//# sourceMappingURL=ComGithubGiantswarmApiextensionsPkgApisProviderV1alpha1AWSConfigSpecAWS.d.ts.map