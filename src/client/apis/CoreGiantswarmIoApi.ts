 ...
 * 
 */
export class CoreGiantswarmIoApi extends runtime.BaseAPI {

    /**
     * get information of a group
     */
    async getCoreGiantswarmIoAPIGroupRaw(): Promise<runtime.ApiResponse<IoK8sApimachineryPkgApisMetaV1APIGroup>> {
     ...
     * get information of a group
     */
    async getCoreGiantswarmIoAPIGroup(): Promise<IoK8sApimachineryPkgApisMetaV1APIGroup> {
        const response = await this.getCoreGiantswarmIoAPIGroupRaw();
